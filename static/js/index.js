...
var wave1 = createWave(context, {
    amplitude: 50,
    duration: 4,
    fillStyle: "rgba(60,99,160,0.8)",//rgba(251,246,239,1)
    frequency: 2.5 * modifier,
    width: vw,
    height: vh,
    segments: 100,
    waveHeight: vh * 0.25
...
var wave3 = createWave(context, {
    amplitude: 100,
    duration: 3,
    fillStyle: "rgba(251,246,239,1)", //rgba(60,99,160,0.8)
    frequency: 2,
    width: vw,
    height: vh,
    segments: 100,
...
function createWave(context, options) {
    ...
    var wave = {
        ...
        points: [],
        segments: options.segments || 80,
        tweens: [],
        waveHeight: options.waveHeight || 80,
    ...
    //Don't load if people don't want animation
...
function resizeCanvas() {
    ...
    vw = document.getElementById("waveholder").offsetWidth;
    vh = 100;
